package com.malt.multilaunch.launcher.sunrise.test2012;
...
class Test2012Launcher extends SunriseLauncher {

    public Test2012Launcher(
            Config config,
    ...
    protected Map<String, String> additionalLoginArgs() {
        return Map.of("serverType", "Test Toontown 2012");
    }
    ...
    public Path workingDir() {
        return config.test2012WorkingDir();
    }

    @Override
    public String canonicalName() {
        return Server.SUNRISE_TEST_2012.canonicalName();
    }
}
