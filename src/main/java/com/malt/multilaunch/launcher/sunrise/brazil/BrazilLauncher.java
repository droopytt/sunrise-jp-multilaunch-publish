...
public class BrazilLauncher extends SunriseLauncher {

    public BrazilLauncher(
            Config config,
    ...
    public Path workingDir() {
        return config.brazilWorkingDir();
    }

    @Override
    public String canonicalName() {
        return Server.SUNRISE_BRAZIL.canonicalName();
    }
}
